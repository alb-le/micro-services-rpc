...
PORT: int = int(os.getenv("PORT", 51))
SERVER_PORT: int = int(os.getenv("SERVER_PORT", 51))

NUM_SERVICE_HOST: str = os.getenv(
    "NUM_SERVICE_HOST", get_host_name("num-service", "localhost")
)
NUM_SERVICE_PORT: int = int(os.getenv("NUM_SERVICE_PORT", 52))

STR_SERVICE_HOST: str = os.getenv(
    "STR_SERVICE_HOST", get_host_name("str-service", "localhost")
)
STR_SERVICE_PORT: int = int(os.getenv("STR_SERVICE_PORT", 53))
