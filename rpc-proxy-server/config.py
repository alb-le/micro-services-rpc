...
NUM_SERVICE_PORT: int = int(
    os.getenv("NUM_SERVICE_PORT", get_host_name("rpc-num-service", 5052))
)

STR_SERVICE_HOST: str = os.getenv(
    "STR_SERVICE_HOST", get_host_name("str-service", "localhost")
)
STR_SERVICE_PORT: int = int(
    os.getenv("STR_SERVICE_PORT", get_host_name("rpc-str-service", 5053))
)
